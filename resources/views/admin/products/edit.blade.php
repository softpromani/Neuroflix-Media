                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="short_description"
                                          ...
                                          placeholder="Brief description for product cards...">{{ old('short_description', $product->short_description) }}</textarea>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="long_description"
                                          id="long_description"
                                          rows="10"
                                          class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:border-neuro-gold focus:outline-none @error('long_description') border-red-500 @enderror">{{ old('long_description', $product->long_description) }}</textarea>
